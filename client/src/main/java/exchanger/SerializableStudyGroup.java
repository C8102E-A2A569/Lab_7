...
public class SerializableStudyGroup implements Serializable {
    ...
    public static SerializableStudyGroup fromStudyGroup(StudyGroup studyGroup) {
        if (studyGroup == null) {
            return null;
        }
        return new SerializableStudyGroup(
                studyGroup.getName(), studyGroup.getCoordinates(), studyGroup.getStudentsCount(),
                studyGroup.getFormOfEducation(), studyGroup.getSemesterEnum(), studyGroup.getGroupAdmin(),
